...
# Using https://github.com/anapsix/docker-alpine-java/blob/master/8/144b01/server-jre/standard/Dockerfile to put java on top of the official node 6 apline image
